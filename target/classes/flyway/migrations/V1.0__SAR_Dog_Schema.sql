...
CREATE TABLE IF NOT EXISTS Canines (
  ...
  FOREIGN KEY (Handlers_idHandlers) REFERENCES Handlers (idHandlers) ON DELETE CASCADE)
 --  INDEX `fk_Canines_Handlers_idx` (`Handlers_idHandlers` ASC) VISIBLE,
  ...
  --   FOREIGN KEY (`Handlers_idHandlers`)
    ...
    -- REFERENCES `Handlers` (`idHandlers`)
    -- ON DELETE NO ACTION
    -- ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
DROP TABLE IF EXISTS Certifications_has_Canines ;

-- CREATE TABLE IF NOT EXISTS `SAR_DOGS`.`Certifications_has_Canines` (
CREATE TABLE IF NOT EXISTS Certifications_has_Canines (
  ...
  FOREIGN KEY (Certifications_idCertifications) REFERENCES Certifications (idCertifications) ON DELETE CASCADE,
  FOREIGN KEY (Canines_idCanines) REFERENCES Canines (idCanines) ON DELETE CASCADE);
