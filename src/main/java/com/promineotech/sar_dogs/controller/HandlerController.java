...
public interface HandlerController {
	...
	@Operation(
			...
			parameters = {
					...
					@Parameter(name = "HomeStreet2", required = false, description = "The HomeAddress2 is a String"),
					...
					@Parameter(name = "MailingStreet2", required = false, description = "The MailingAddress2 is a String"),
